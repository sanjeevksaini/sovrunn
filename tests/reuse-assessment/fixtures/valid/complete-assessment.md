...
|---|---|---|---|
| Incorrect capability classification | Capability-level disposition rules and closed vocabularies | RA-S03 structural validation; human semantic review | Correct assessment disposition field |
| Vendor-first architecture | Provider-neutrality field; no vendor selection | Human review of candidates and non-goals | Remove vendor coupling; re-assess |
| Direct external coupling | Mandatory adapter fields and DEC-0036 traceability | RA-C01/RA-C02 checks; human review | Add adapter boundary decision |
