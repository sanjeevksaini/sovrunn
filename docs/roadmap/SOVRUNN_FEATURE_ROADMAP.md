...
| FEATURE-0018 | Governance, IAM, Approval and Exception Foundation | Requirements approved for design | AccessGroup and Membership; scoped RoleDefinition/RoleAssignment; exact-Human PrincipalRef-only approval/review/privileged eligibility; privileged access; approval; access review; immutable exception evidence; FEATURE-0018-limited GovernanceProfile; exact local conformance under ADH-2026-071. |
