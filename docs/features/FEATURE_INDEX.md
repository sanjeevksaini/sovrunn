...
| FEATURE-0047 | Provider Onboarding Workflow | Phase 5: Provider / Plugin Framework and Certification | Roadmap Placeholder | `provider-onboarding-workflow` | Guide provider/MSP through Provider, ProviderLocation, InfrastructureStack, ResourcePool, and capability onboarding. |
