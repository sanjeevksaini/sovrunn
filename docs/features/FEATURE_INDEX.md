...
| FEATURE-0013 | Decision Record and AuditEvent Standard | Phase 2: Reuse-First PaaS Fabric Foundation | Executable | `decision-object-and-auditevent-standard` | Define common DecisionRecord and AuditEvent structure. ADH-2026-014, ADH-2026-015, and ADH-2026-016 jointly controlling; ADH-2026-015 supersedes only the earlier six-scope AuditEvent statement; ADH-2026-016 clarifies contract boundaries (metadata.scopeRef sole scope authority, sensitivity vocabulary, structural-only security validation, deferred cryptographic boundary ADR-F13-002, conformance IDs F13-CF-01..F13-CF-28) and returned requirements to architecture-remediation status. |
