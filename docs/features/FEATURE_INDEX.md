...
| FEATURE-0014 | Provider-Neutral Resource Model | Phase 2: Reuse-First PaaS Fabric Foundation | Requirements Ready | `provider-neutral-resource-model` | Define Provider, ProviderLocation, ProviderDatacenter, DatacenterFailureDomain, and InfrastructureStack only under ADH-2026-018. |
