...
| FEATURE-0013 | Decision Record and AuditEvent Standard | Phase 2: Reuse-First PaaS Fabric Foundation | Architecture Approved; Requirements Authorized | `decision-object-and-auditevent-standard` | Approved replacement ADH-2026-017 controls the complete DecisionRecord and AuditEvent architecture. It preserves FEATURE-0012's six governance scopes and models ServiceInstance as a typed subject within its governing scope. Fresh requirements generation is authorized; later stages remain separately gated. |
