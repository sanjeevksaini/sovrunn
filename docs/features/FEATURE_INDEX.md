...
| FEATURE-0015 | Canonical Cloud Model and Alpha Migration Foundation | Phase 2R: Canonical Model PaaS Fabric Foundation | Executable | `canonical-cloud-model-and-alpha-migration` | Seven-scope migration; CloudPlatform; CloudProvider; CloudProviderParticipation; HostingLocation; Datacenter; FaultDomain; InfrastructureStack; ExecutionTarget identity; CanonicalMigrationPlan/Record; no ResourcePool/ProviderCapability. |
