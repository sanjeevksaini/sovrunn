...
| FEATURE-0013 | Decision Record and AuditEvent Standard | Phase 2: Reuse-First PaaS Fabric Foundation | Executable | `decision-object-and-auditevent-standard` | Define common DecisionRecord and AuditEvent structure. ADH-2026-014 controlling. |
