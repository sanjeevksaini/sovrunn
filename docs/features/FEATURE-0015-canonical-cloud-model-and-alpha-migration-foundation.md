...
| REQ-F15-08 | Deterministic dry-run: convert alpha Provider/topology fixtures to canonical representations; report zero unresolved authorities, zero ambiguous references, no dual writers | DEC-0058; ADH-041 | VS0-CF-MIG01 |
...
| REQ-F15-10 | Seven canonical scope kinds enforced in all FEATURE-0015 scopeRef validations | DEC-0037 | VS0-SCHEMA-001 |
...
|----|-----------|----------------|
| AC-F15-01 | CloudPlatform, CloudProvider, topology chain CRUD works with validation | VS0-CF-HP01 |
| AC-F15-02 | CloudProviderParticipation lifecycle state machine enforced | VS0-CF-HP01, VS0-CF-F09 |
| AC-F15-03 | ExecutionTarget identity (spec) registered; no status fields introduced or persisted by FEATURE-0015 | VS0-CF-HP01 |
...
| AC-F15-08 | Writer enforcement: unauthorized writes to topology/platform specs denied | VS0-CF-F02 |
...
| AC-F15-11 | Migration controller cannot create or mutate CanonicalMigrationPlan; plan publisher cannot append CanonicalMigrationRecord | VS0-CF-MIG01,MIG02 |
