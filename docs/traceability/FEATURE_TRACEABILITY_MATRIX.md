...
| FEATURE-0013 | Phase 2 | Architecture Approved; Requirements Pending Human Review | TENET-012, TENET-013 | DEC-0026, DEC-0036 | RFC-0023 | Kiro requirements returned to PENDING_HUMAN_REVIEW | ADH-2026-014 and ADH-2026-015 (joint controlling, 2026-07-27); DecisionRecord terminology correction; ScopeKind single canonical seven-value vocabulary (adds ServiceInstance, retains Provider); AuditEvent permits all seven via metadata.scopeRef; ADH-2026-015 supersedes only the earlier six-scope statement; compatibility evidence at docs/traceability/ADH-2026-015-scope-vocabulary-compatibility.md; fresh independent requirements approval required before design |
