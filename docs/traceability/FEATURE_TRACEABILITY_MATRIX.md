...
| FEATURE-0018 | Phase 2R | Requirements approved for design | DEC-0050; DEC-0060 (Accepted) | ADH-2026-070 core + Appendices A/B; ADH-2026-071; `docs/architecture/FEATURE-0018-governance-iam-approval-exception-foundation.md`; VS0-CF-F18-01..54 except retired F18-38; renewal-05 | Architecture and fresh requirements-generation authorization recorded; exact REQ/AC conformance mapping reconciled without new runtime semantics; independent requirements review approved with `APPROVED_FOR_DESIGN`; tasks/implementation remain unauthorized |
