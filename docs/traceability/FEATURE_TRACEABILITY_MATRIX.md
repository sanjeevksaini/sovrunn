...
| FEATURE-0013 | Phase 2 | Architecture Approved; Requirements in Architecture-Remediation (Pending Human Review) | TENET-012, TENET-013 | DEC-0026, DEC-0036 | RFC-0023 | Kiro requirements PENDING_HUMAN_REVIEW; gate PENDING_INDEPENDENT_REVIEW | ADH-2026-014, ADH-2026-015, and ADH-2026-016 (joint controlling, 2026-07-27); DecisionRecord terminology correction; ScopeKind single canonical seven-value vocabulary (adds ServiceInstance, retains Provider); AuditEvent permits all seven via metadata.scopeRef; ADH-2026-015 supersedes only the earlier six-scope statement; ADH-2026-016 clarifies contract boundaries (DecisionRecord metadata.scopeRef sole scope authority; sensitivity vocabulary PUBLIC<INTERNAL<CONFIDENTIAL<RESTRICTED; structural-only security validation; deferred cryptographic boundary ADR-F13-002; conformance IDs F13-CF-01..F13-CF-28; six-scope evidence SUPERSEDED) and returned requirements to architecture-remediation; seven-value compatibility evidence at docs/traceability/ADH-2026-015-scope-vocabulary-compatibility.md (authoritative), six-scope evidence at docs/traceability/ADH-2026-014-six-scope-auditevent-compatibility.md (superseded); fresh independent requirements approval required before design |
