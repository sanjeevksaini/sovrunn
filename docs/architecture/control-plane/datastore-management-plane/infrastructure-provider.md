...
Definition:
  Integrates Datastore Management Plane with infrastructure environments such as AWS, Azure, GCP, Kubernetes, VMware, bare metal, private cloud, sovereign cloud, or hybrid cloud.

Responsibilities:
  MUST:
    - Integrate infrastructure environment
    - Provision infrastructure primitives where authorized
    - Declare environment capabilities
    - Report infrastructure operation state
  ...
  MUST NOT:
    ...
    - Be treated as Foundation Provider
    - Own datastore-specific lifecycle semantics
