...
Document:
  ID: infrastructure-provider-registry
  Title: Infrastructure Provider Registry
...
Purpose:
  - Define Infrastructure Provider Registry
  - Define responsibilities and boundaries
  - Support selective AI retrieval

Definition:
  Stores Infrastructure Provider metadata and lifecycle state.

Responsibilities:
  MUST:
    - Register Infrastructure Provider metadata
