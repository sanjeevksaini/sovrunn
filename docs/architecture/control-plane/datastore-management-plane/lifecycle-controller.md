...
Purpose:
  - Define Lifecycle Controller
  - Define responsibilities and boundaries
  - Support selective AI retrieval

Definition:
  Coordinates datastore lifecycle workflows across controllers, operator plugins, and infrastructure providers.

Responsibilities:
  MUST:
    - Coordinate lifecycle workflows
    - Enforce lifecycle state machine
    - Coordinate rollback or compensation where defined
