...
Definition:
  Sovrunn capability for managed downstream datastore operations.

Responsibilities:
  MUST:
    - Expose managed datastore operations
    - Route operations to Datastore Management Plane
    - Preserve lifecycle policy and audit
