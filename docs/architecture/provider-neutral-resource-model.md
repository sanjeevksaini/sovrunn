...
| `F14-R16` | Sovereignty | Geographic descriptors are inaccurate, ambiguous, or treated as proof of residency/compliance. | 4×5 Critical | `F14-AD-011`, `014`, `017` | Use mature normalized codes where applicable; treat geography as declared topology, not compliance evidence or policy outcome. | Invalid/unknown code fixtures; semantic review proving no residency inference. | 2×4 Medium | Sovereignty/domain owner | Geography becomes a policy, placement, or attestation input. |
...
| `F14-AD-011` | Stack technology is descriptive only; examples are not kinds, native identities, capability declarations, or a closed compatibility enum. | Technology metadata cannot drive compatibility or placement in FEATURE-0014. |
